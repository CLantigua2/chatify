...
const Button = styled.button`
  ...
  ${props =>
    props.red
      ? `border: 2px solid rgb(255,163,140);; color: rgb(255,154,119)`
      : null};
  ${props =>
    props.green
      ? `border: 2px solid rgb(80, 230, 100); color: rgb(80, 230, 100)`
      : null};
  ...
  &:hover {
    ...
    ${props =>
      props.red
        ? `border: 2px solid rgb(255,163,140);; background-color: rgb(255,154,119); color: white`
        : null};
    ${props =>
      props.green
